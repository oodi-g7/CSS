...
- 정렬의 기준이 되는 방향을 결정하는 속성
    - flex-direction : row(기본값)
        ...
        <img src="./img/flex_layout/1-1.png" style="width:300px;">
    - flex-direct : column

        <img src="./img/flex_layout/1-2.png" style="height:300px;">
...
- 따라서 양 끝에 있는 아이템이 start 또는 end라인과 갖는 여백은, 아이템 간의 여백보다 좁다.
    <img src="./img/flex_layout/1-7.png">

#### 3-3-6. justify-content : space-evenly
- space-evenly는 모든 여백의 크기가 균일함
    <img src="./img/flex_layout/1-8.png">

### 3-4. align-items : 중심축 반대 방향 정렬

<img src="./img/flex_layout/1-13.jpg">
...
- 아이템의 실제 사이즈가 어떻든간에, 아이템을 쭉쭉 늘려서 container영역을 꽉 채워줌
    ...
    <img src="./img/flex_layout/1-9.png">
#### 3-4-2. align-items : flex-start
- container의 시작점을 기준으로 정렬

    <img src="./img/flex_layout/1-10.png">
#### 3-4-3. align-items : flex-end
- container의 끝지점을 기준으로 정렬

    <img src="./img/flex_layout/1-11.png">
#### 3-4-4. align-items : center
- 중앙을 기준으로 정렬

    <img src="./img/flex_layout/1-12.png">
